            ...
            <main>
                <form onSubmit={handleCreateClass}>
                    <fieldset>
                        ...
                        <Input name="whatsapp" label="WhatApp" value={whatsapp} onChange={e => { setWhatsapp(e.target.value) }} />
                        ...
                        {scheduleItems.map((scheduleItem, index) => {
                            return (
                                <div key={scheduleItem.week_day} className="schedule-item">
                                    ...
                                    />
                                    <Input name="from" label="Das" type="time" onChange={e => setScheduleItemsValue(index, 'from', e.target.value)} value={scheduleItem.from} />
                                    <Input name="to" label="Até" type="time" onChange={e => setScheduleItemsValue(index, 'to', e.target.value)} value={scheduleItem.to} />
                                </div>
                            )
                        })}
                    </fieldset>
